...
font_kwargs = dict(fontfamily="monospace",fontweight="bold",  fontsize="large") # fontweight="bold"
...
for row in ['A','B']:
    ...
    i = row + '0'
    # ==== Training Acc
    axes[i].plot(np.arange(800), 1 - acc['ls0'].values, label='$\delta=0$', color=cmap1(norm(1)))
    axes[i].plot(np.arange(800), 1 - acc['ls0.05'].values, label='$\delta=0.05$', color=cmap1(norm(2)))
    axes[i].plot(np.arange(800), 1 - acc['ls0.1'].values, label='$\delta=0.1$', color=cmap1(norm(3)))
    axes[i].plot(np.arange(800), 1 - acc['ls0.2'].values, label='$\delta=0.2$', color=cmap1(norm(4)))
    axes[i].plot(np.arange(800), 1 - acc['ls0.5'].values, label='$\delta=0.5$', color=cmap1(norm(5)))
    axes[i].plot(np.arange(800), 1 - acc['ls0.8'].values, label='$\delta=0.8$', color=cmap1(norm(6)))
    axes[i].plot(np.arange(800), 1 - acc['ls0.9'].values, label='$\delta=0.9$', color=cmap1(norm(7)))
    ...
    axes[i].plot(nc1['Step'].values - 1, nc1['ls0.5'].values, label='$\delta=0.5$', color=cmap1(norm(5)))
    axes[i].plot(nc1['Step'].values - 1, nc1['ls0.8'].values, label='$\delta=0.8$', color=cmap1(norm(6)))
    axes[i].plot(nc1['Step'].values - 1, nc1['ls0.9'].values, label='$\delta=0.9$', color=cmap1(norm(7)))
    ...
    axes[i].plot(nc1['Step'].values - 1, nc2['ls0.5'].values, label='$\delta=0.5$', color=cmap1(norm(5)))
    axes[i].plot(nc1['Step'].values - 1, nc2['ls0.8'].values, label='$\delta=0.8$', color=cmap1(norm(6)))
    axes[i].plot(nc1['Step'].values - 1, nc2['ls0.9'].values, label='$\delta=0.9$', color=cmap1(norm(7)))
    ...
    axes[i].plot(nc1['Step'].values - 1, nc3['ls0.5'].values, label='$\delta=0.5$', color=cmap1(norm(5)))
    axes[i].plot(nc1['Step'].values - 1, nc3['ls0.8'].values, label='$\delta=0.8$', color=cmap1(norm(6)))
    axes[i].plot(nc1['Step'].values - 1, nc3['ls0.9'].values, label='$\delta=0.9$', color=cmap1(norm(7)))
...
# fig.suptitle("Model Convergence with Different Smoothing Hyperparameter")
    ...
    # i = row + '4'
    # # ==== Testing Acc
    # axes[i].plot(np.arange(800), 1 - test_acc['ls0'].values, label='$\delta=0$', color=cmap1(norm(1)))
    # axes[i].plot(np.arange(800), 1 - test_acc['ls0.05'].values, label='$\delta=0.05$', color=cmap1(norm(2)))
    # axes[i].plot(np.arange(800), 1 - test_acc['ls0.1'].values, label='$\delta=0.1$', color=cmap1(norm(3)))
    # axes[i].plot(np.arange(800), 1 - test_acc['ls0.2'].values, label='$\delta=0.2$', color=cmap1(norm(4)))
    # axes[i].plot(np.arange(800), 1 - test_acc['ls0.5'].values, label='$\delta=0.5$', color=cmap1(norm(5)))
    # axes[i].plot(np.arange(800), 1 - test_acc['ls0.8'].values, label='$\delta=0.8$', color=cmap1(norm(6)))
    # axes[i].plot(np.arange(800), 1 - test_acc['ls0.9'].values, label='$\delta=0.9$', color=cmap1(norm(7)))
